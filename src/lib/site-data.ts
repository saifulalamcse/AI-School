...
export const news = [
  {
    title: "God Mode Unlocked in ChatGPT 5",
    tag: "Product",
    summary:
  ...
  {
    title: "Boring Office Tasks, Gone in a Prompt",
    tag: "Productivity",
    summary:
      "Reports, meeting notes and spreadsheet clean-up now take minutes. We break down the five prompts that replace an afternoon of admin.",
  },
  {
    title: "Einstein's Brain in a ChatGPT Custom",
    tag: "Culture",
    summary:
      "Custom personas are becoming study partners. We look at how learners are building tutors that actually explain instead of summarise.",
  },
  {
    title: "Gemini 3 Rewrites the Enterprise AI Playbook",
    tag: "Enterprise",
    summary:
      "Long context plus native tool calling is pushing teams from chat toys to real internal systems. What that means for freelancers selling AI services.",
  },
  {
    title: "Sora Long-Form Now Beats TV Ads",
    tag: "Video",
    summary:
  ...
  {
    title: "Claude Opus 5 Ships Agent-Native Tools",
    tag: "Agents",
    summary:
      "Agents that plan, browse and write files reliably are finally usable. We tested it on a real client automation and logged the results.",
  },
] as const;
